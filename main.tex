...
Получаем неопределённость: $$\biggl[\dfrac{0}{0}\biggr]$$
Делим на $x^{\dfrac{3}{2}}$ верхнюю и нижнюю часть:
...
г)
$$\lim\limits_{x\rightarrow 1} (\frac{2x-1}{x})^{\dfrac{1}{\sqrt[3]{x}-1}}  $$
Подставляя значение получим:
$$[ 1^{\infty}]$$
Используя секретную формулу \textnumero $197$ получим:
$$e^{\lim\limits_{x\rightarrow 1} (\dfrac{2x-1}{x} - 1)({\dfrac{1}{\sqrt[3]{x}-1}})}$$
Считаем чему равна степень:
$$\lim\limits_{x\rightarrow 1} (\dfrac{2x-1}{x} - 1)({\dfrac{1}{\sqrt[3]{x}-1}})$$
$$\lim\limits_{x\rightarrow 1} (\dfrac{x-1}{x})({\dfrac{1}{\sqrt[3]{x}-1}})$$
